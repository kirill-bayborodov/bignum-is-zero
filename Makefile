...
SUBMODULES_INCLUDE_DIR := $(strip $(SRC_PATHS) $(DIST_PATHS))
...
# ----------------------------------------------------------------------
#  Symlink the core header into the include tree
# ----------------------------------------------------------------------
#LIBS_DIR        := libs/bignum-core/dist = FAMILY_PATH
#CORE_HDR        := $(LIBS_DIR)/bignum_core.h = FAMILY_HEADER
#SYMLINK_HDR     := $(LIBS_DIR)/bignum.h
